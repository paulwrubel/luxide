...
export type RawMaterialData = RawMaterialDielectric | RawMaterialLambertian | RawMaterialSpecular;
...
export function getMaterialDataSafe(
  ...
  try {
    ...
    console.warn(`Failed to get material data (${nameOrData}), using default material`, e);
    return {
...
export function defaultMaterialForType(type: MaterialData['type']): MaterialData {
  switch (type) {
    case 'dielectric':
      return {
        type: 'dielectric',
...
function normalizeMaterialDielectric(
  ...
  if (typeof material.reflectance_texture !== 'string') {
    ...
    config.textures[textureName] = normalizeTextureData(config, textureName, material.reflectance_texture);
  ...
  if (typeof material.emittance_texture !== 'string') {
    ...
    config.textures[textureName] = normalizeTextureData(config, textureName, material.emittance_texture);
