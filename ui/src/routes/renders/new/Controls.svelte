...
<FormField class="drawer-element">
	<Slider bind:value={renderConfig.parameters.image_dimensions[0]} min={100} max={5000} step={10} />
	Width = {renderConfig.parameters.image_dimensions[0]}
</FormField>
<FormField class="drawer-element">
	<Slider bind:value={renderConfig.parameters.image_dimensions[1]} min={100} max={5000} step={10} />
